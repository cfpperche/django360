...
angular.module('app.webapp.modules', [])
...
.controller('ModulesCtrl', [
	...
	function($scope, $state, anchorSmoothScroll, $location, $log, $modal, $sce) {
		...
		$scope.openDisqus = function(size, moduledisqus) {
			...
			var templateModal = '<div class="modal-header"><span><h4 class="modal-title"><i class="fa fa-lg fa-comments-o"> {{disqus.title}}</i></h4></span>' + '<span class="close"><button class="btn btn-danger" ng-click="close()"><i class="fa fa-lg fa-times"></i></button></span></div>' + '<div class="modal-body"><app-disqus-comments disqus-shortname="{{disqus.shortname}}"' + 'disqus-identifier="{{ disqus.id }}" disqus-url="{{ disqus.url }}" ready-to-bind="{{ contentLoaded }}"> </app-disqus-comments></div>';
		...
		$scope.openGist = function(size, gist) {
			...
			var templateModal = '<div class="modal-header"><span><h4 class="modal-title"><i class="fa fa-lg fa-github-alt"> Gist</i></h4></span>' + '<span class="close"><button class="btn btn-danger" ng-click="close()"><i class="fa fa-lg fa-times"></i></button></span></div>' + '<div class="modal-body" style="padding: 0px;"><app-gist gist="{{gist}}" ready-to-bind="{{contentLoaded}}"></app-gist></div>';
		...
		$scope.openSlideshare = function(size, slideshare) {
			...
			var templateModal = '<div class="modal-header"><span><h4 class="modal-title"><i class="fa fa-lg fa-slideshare"> Slideshare</i></h4></span>' + '<span class="close"><button class="btn btn-danger" ng-click="close()"><i class="fa fa-lg fa-times"></i></button></span></div>' + '<div class="modal-body" style="padding: 0px;"><app-slideshare slideshare-url="{{slideshare.url}}" ready-to-bind="{{contentLoaded}}"></app-slideshare></div>';
		...
		$scope.openYoutube = function(size, youtube) {
			...
			$scope.youtube = youtube;
			var templateModal = '<div class="modal-header"><span><h4 class="modal-title"><i class="fa fa-lg fa-youtube"> Youtube</i></h4></span>' + '<span class="close"><button class="btn btn-danger" ng-click="close()"><i class="fa fa-lg fa-times"></i></button></span></div>' + '<div class="modal-body" style="padding: 0px;"><app-youtube youtube-url="{{youtube.url}}" ready-to-bind="{{contentLoaded}}"></app-youtube></div>';
